...
const Analytics = () => {
  ...
  const statusData = [
    { label: 'Pending', value: pending, color: 'from-violet-600 to-purple-600', icon: <Clock3 size={16} /> },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#0f172a] border border-slate-800 rounded-2xl p-6">
          ...
          {topCompanies.length === 0 ? (
            ...
            <div className="space-y-4 max-h-80 overflow-y-auto scrollbar-subtle">
              {topCompanies.map(([company, count], index) => (
                <div key={company} className="flex items-center justify-between p-3 bg-[#020817] rounded-xl hover:bg-slate-800/50 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">{capitalizeWords(company)}</p>
